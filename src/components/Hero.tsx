            ...
            <div className='w-full h-3/5 flex items-center'>
                <div className='text-black dark:text-gray-300'>
                    ...
                    <p className='text-sm leading-6 font-victor my-5'>
                        ...
                        <a target={"_blank"} href={"racipe-project-front.vercel.app/"} rel="noreferrer" className='p-0 underline font-victor capitalize text-black dark:text-gray-300 visited:text-black visited:dark:text-gray-300'>Aamfeer Kitchen</a>,&nbsp;
                        <a target={"_blank"} href={"tixbuddy.netlify.app/"} rel="noreferrer" className='p-0 underline font-victor capitalize text-black dark:text-gray-300 visited:text-black visited:dark:text-gray-300'>TixBuddy</a>&nbsp;and a&nbsp;
                        <a target={"_blank"} href={"liquidtron.netlify.app/"} rel="noreferrer" className='p-0 underline font-victor capitalize text-black dark:text-gray-300 visited:text-black visited:dark:text-gray-300'>Token Pre-sale DApp</a>. But those aren’t the only projects—if you want to know more about me, feel free to check out my LinkedIn. And if you’re really interested in seeing my code (it’s a bit messy!), head over to my GitHub. <br /> <br />
